...
md"
=====================================================================================
#### SICP: 1.3.2.1 Constructing Procedures Using Lambda: Basics
##### file: PCM20210818\_SICP\_1.3.2.1\_ConstructingProceduresUsingLambda\_I.jl
##### Julia/Pluto.jl-code (1.11.4/0.20.4) by PCM *** 2025/04/01 ***
...
md"
---
##### 3.1 Definitions with *Anonymous* Functions
###### 3.1.1 *CS* Definition within $\lambda$-*calculus*
$\lambda: Any \rightarrow Any$
...
---
###### 3.1.2 *CS* Example: *the procedure that returns its input incremented by 4* 

(SICP, 1996, p.62; 2016, p.83)

$\lambda: x \mapsto \lambda(x) x + 4.$
...
# ╔═╡ f0b6b8f0-c905-4a77-935f-0962b180764a
md"
###### *Julia* Example: *the (anonymous) procedure that returns its input incremented by 4* 
...
(x -> +(x, 4))(2)                           # application to argument '2'

# ╔═╡ bb7e8e2f-94cf-4713-b36c-92e7816b6a34
md"
---
###### 3.1.2 Example: the (*anonymous*) procedure returning a reciprocal 
(SICP, 1996, p.62; 2016, p.83)
...
(function(x) /(1.0, *(x, +(x, 2))) end)(2)  # application to '2'

# ╔═╡ 1ae10bc5-b8eb-41d0-89c7-d80c9cc598e8
x -> /(1.0, *(x, +(x, 2)))                  # definition with '->'

# ╔═╡ dd2922e7-ea2c-4457-bedd-6ae3885a42ac
(x -> /(1.0, *(x, +(x, 2))))(2)             # application to '2'

# ╔═╡ d9391ae3-631b-4e11-b855-22509947512c
md"
---
###### 3.1.3 Recursive Function $sumRec$
(SICP, 1996, p.58; 2016, p.77f)
"
...
function sumRec(term, a, next, b)
	>(a, b) ? 
		0 :
		+(term(a), sumRec(term, next(a), next, b))
end # function sumRec

# ╔═╡ 37f91cdf-6ac3-4559-a90c-04dcb4dcbd38
md"
(SICP, 1996, p.62; 2016, p.83)
"

# ╔═╡ 433ed93c-2c05-4bed-826e-eca8153bd30b
function pi_sumRec(a, b)
	sumRec(x -> /(1.0, *(x, +(x, 2))), a, x -> +(x, 4), b)
end # function pi_sumRec

# ╔═╡ 962ca66e-ffe4-4625-b5ed-a2dc29072c15
function integralRec(f, a, b, dx)
	*(sumRec(f, +(a, /(dx, 2.0)), x -> +(x, dx), b), dx)
end # function integralRec

# ╔═╡ 9754ae8a-180d-4da6-90ef-13e660f05dd1
8 * pi_sumRec(1, 1E5)                           # SICP, 1996, p.59; 2016, p.79

# ╔═╡ 0e62cb84-96d7-46dc-8976-2ff7fb28f7dc
π

# ╔═╡ 96a9bc8d-c342-43b2-9a7a-f66c7ccc20a2
abs(8 * pi_sumRec(1, 1E5) - π)

# ╔═╡ 617b5094-bd33-455b-b1e4-87c214f21d60
md"
---
###### 3.1.4 Integral of Cubic Function
(SICP, 1996, p.60, p.62; 2016, p.79, p.83)

$\int_0^1 x^3 dx = \left[\frac{x^4}{4}\right]_0^1=\left[\frac{1^4}{4}-\frac{1^0}{4}\right]=\frac{1}{4}.$
...
integralRec(x-> x^3, 0, 1, 0.001)                # ==> 0.25 -->  :)

# ╔═╡ 6132d02f-7bd8-4e1d-aea5-212fefc2d355
begin 
	plot(x -> x^3, 0, 1, size=(600, 500), xlim=(0.0, 1.1), ylim=(0.0, 1.2), line=:darkblue, fill=(0, :lightblue), aspect_ratio=1, framestyle=:semi, title=L"f: x \mapsto x^3", xlabel=L"x", ylabel=L"f: x \mapsto x^3", label=L"f: x \mapsto x^3")
	annotate!(.8, 0.13, L"\int_0^1 x^3 dx = \frac{1}{4}", 12)
end # begin

# ╔═╡ 23e0515e-8023-41e0-b6d7-dd416d9db9a7
md"
---
###### 3.1.5 Integral of Halfparabola
(Stark, P.A., *Introduction to Numerical Methods*, 1970, ch. 6.2-6.3, p. 196, Example 6-1)
...
integralRec(x->-(6, *(6, ^(x, 5))), 0.0, 1.0, 1.0E-4) # ==> 5.0  --> :)

# ╔═╡ a0f823ca-0a55-482a-9675-3c82fc86bd56
begin
	plot(x->-(6, *(6, ^(x, 5))), 0, 1, size=(400, 400), xlim=(0.0, 1.2), ylim=(0.0, 6.2), line=:darkblue, fill=(0, :lightblue), framestyle=:semi, title=L"f: x \mapsto (6-6x^5)", xlabel=L"x", ylabel=L"f: x \mapsto (6-6x^5)", label=L"f: x \mapsto (6-6x^5)")
	annotate!(0.45, 1.5, L"\int_0^1 (6-6x^5) dx = 5", 12)
end # begin

# ╔═╡ f062cf19-6507-4382-b450-57cf91c9d3a4
md"
---
###### 3.1.6 *Flat, redundant* Definition of Functions

(SICP, 1996, p.63; 2016, p.85)
...
# ╔═╡ a5da9c79-e4fd-4bc2-83c3-f89cee56925e
md"
###### Definition of Function $f1$ with *Prefix* Operators
"

# ╔═╡ 0c7b960d-35cf-4391-9496-7088b5a54326
f1(x, y) =                            # prefix operators
	+(*(x,(+(1, *(x, y))^2)),         # x(1+xy)^2
	  *(y, -(1, y)),                  # y(1-y)
	  *(+(1, *(x, y)), -(1, y)))      # (1+xy)(1-y)

# ╔═╡ 42c074af-0452-458b-aae6-0eb22507883b
f1(1, 2)                              # application of f1

# ╔═╡ bc9797ce-41e8-440f-b6fa-6f21c3a61224
md"
###### Definition of Function $f2$ with *Infix* Operators
"
...
f2(1, 2)                              # application of f2

# ╔═╡ 14369a73-db5d-417e-a605-e31894b53a9c
md"
---
###### 3.1.7 *Hierarchical* Definition of Functions with *Helper* Function and *Local* Variables

(SICP, 1996, p.63f; 2016, p.85)
...
# ╔═╡ 74464592-ce9b-4a15-b481-5723c6833a59
md"
---
###### 3.1.8 *Hierarchical* Definition of Functions with *Anonymous* Function and *Local* Variables

(SICP, 1996, p.64; 2016, p.85f)
"
...
# ╔═╡ 4ad55409-cf8f-4dc2-a83b-36b0600d4b9d
md"
---
###### 3.1.9 *Hierarchical* Definition of Functions with *Let* and *Local* Variables

(SICP, 1996, p.60; 2016, p.86)
"
...
function f6(x, y)
	let a = +(1, *(x, y)), b = -(1, y) # definition of local variables
...
# ╔═╡ e131a94d-a79d-400b-8e76-eb7f211ffa72
md"
---
###### 3.1.10  Definition of Function only with *Local* Variables

(SICP, 1996, p.64; 2016, p.88)
"
...
# ╔═╡ 36ced964-f7b3-4bc6-8c50-49879c61e7b4
function f8(x, y)
	a = 1 + x * y
	b = 1 - y
	(x * a^2) + (y * b) + (a * b)
...
# ╔═╡ a7f8e71f-49f6-4e1b-aceb-9d1c3da83915
f8(1, 2)

# ╔═╡ 973f5f48-040b-4552-9528-1e3dee12b49c
md"
---
##### 3.2 Application of λ-style Functions
...
md"
---
###### 3.2.2 ISS (= Imperative Sequential Style)
"
...
md"
---
###### 3.2.3 NLS (= Nested Lambdas Style)
"
...
md"
---
##### 3.3 Application of λ-style Functions to Linear Recursive Example: *Factorial*
...
md"
---
###### 3.3.2 ISS (= Imperative Sequential Style)
"
...
md"
---
###### 3.3.3 NLS (Nested Lambda Style)): $factorialNLS2$ 
"
...
md"
---
##### 3.4 Application of λ-style Functions to *Tail-Recursive Factorial*
"
...
function sumIter(term::Function, a::FloatOrSigned, next::Function, b::FloatOrSigned)::FloatOrSigned
	sum = 0
	while !(a > b)
		sum += term(a)
		a = next(a)
	...
	sum
end # function sumIter

# ╔═╡ 066538f0-0a85-4763-97aa-85caaaf9fd6e
function pi_sumIter(a::FloatOrSigned, b::FloatOrSigned)::FloatOrSigned
	sumIter(function(x) 1.0 / (x * (x + 2)) end , a, function(x) x+4 end, b)
end # function pi_sumIter

# ╔═╡ 1b92beeb-8d34-45cd-807d-8b3aef90526c
8 * pi_sumIter(1, 1E5)

# ╔═╡ 00b2e013-5134-4181-8e0e-e07babc4bf46
deviation = abs(8 * pi_sumIter(1, 1E5) - pi)

# ╔═╡ 986c3531-565a-48eb-8ffe-20411ac119dc
function integralIter(f::Function, a::FloatOrSigned, b::FloatOrSigned, dx::FloatOrSigned)::FloatOrSigned
	sumIter(f, a+dx/2.0, function(x) x+dx end, b) * dx
end # function integral2

# ╔═╡ 96e52bd7-bda8-41e6-8560-1e85dbd275b1
integralIter(x->x^3, 0, 1, 0.001)

# ╔═╡ 94a7ffea-8915-4880-9e31-b6b01c6d27b8
integralIter(x->-6x^5+6, 0.0, 1.0, 1.0E-4) # should be 5.0

# ╔═╡ c7739ffe-064d-467a-8126-a2fcaa7a8336
md"
---
##### 5. Summary
"
