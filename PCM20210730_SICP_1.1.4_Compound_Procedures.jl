...
md"
---
###### 3.3 *Definition* and *Application* of *Generic* Function $f$
...
f1(5) # (5 + 1)^2 + (5 * 2)^2 = 6^2 + 10^2 = 36 + 100 = 136
...
---
##### 6. References
- **Abelson, H., Sussman, G.J. & Sussman, J.**, [*Structure and Interpretation of Computer Programs*](https://mitp-content-server.mit.edu/books/content/sectbyfn/books_pres_0/6515/sicp.zip/full-text/book/book-Z-H-10.html#%_sec_1.1.4), Cambridge, Mass.: MIT Press, (2/e), 1996, last visit 2024/12/08
"
...
manifest_format = "2.0"
project_hash = "ebb176273db630a5d1a06a378cc48bab41282e89"
