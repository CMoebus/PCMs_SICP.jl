...
# ╔═╡ 7a2cc4c8-3cd4-4d36-87bc-91a99f609707
using Plots
...
let
	...
	#------------------------------------------------------------------------------
	plot(xlim=(-2, 10), ylim=(3, 11), legend=:false, ticks=:none)
...
md"
**Fig. 1.1.8.1** Procedural decomposition of $$sqrt$$ script (cf. Fig.1.2, SICP, 1996, 2/e, p.27)
...
md"
**Fig. 1.1.8.2** Excerpt from Julia's *type hierarchy* (a more complete excerpt can be found in Nazarathy & Klok, 2021, p.11, or [here](https://global.discourse-cdn.com/business5/uploads/julialang/original/2X/4/4612397a30b75f0c3d7c48072f142d01d2309fc9.png).
"
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "33d6eb93d8855bda06b3c0ebc23e533c31d61701"
