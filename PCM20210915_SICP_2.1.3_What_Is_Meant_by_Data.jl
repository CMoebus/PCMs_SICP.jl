...
# ╔═╡ 6d148237-b0c2-4eff-aa56-d4ce29a07eb7
begin 
	using Pluto
	using Plots	
...
md"
=====================================================================================
#### SICP: [2.1.3 What Is Meant by Data](https://sarabander.github.io/sicp/html/2_002e1.xhtml#g_t2_002e1_002e3)
...
# ╔═╡ 39224bb4-df67-491b-82e1-e4ae670ad134
md"
---
##### 0. Introduction
Here, we deal with *data abstraction*. *Data abstraction is a methodology that enables us to isolate how a compound data object is used from the details of how it is constructed from more primitive data objects.* (SICP, 1996, 2016)

"

# ╔═╡ a70c770e-19fd-446f-a276-5860b50a2664
md"
---
##### 1. Topics
- *data abstraction*
...
# ╔═╡ 5d0298ef-8a5a-4acc-abec-6856da0f41d0
md"
---
...
md"
---
##### 3. Axioms of [*Abstract Data Type (ADT)*](https://en.wikipedia.org/wiki/Abstract_data_type)
The *implementation* has to obey a *specification* set by following *axioms*:

###### 3.1 Axioms of ADT Rational Number
...
md"
---
###### 3.2 Axioms of ADT *BinaryTuple* $Cons-cell$
...
*... any triple of procedures that satisfies the above condition can be used as the basis for implementing pairs. This point is illustrated strikingly by the fact that we could implement cons, car, and cdr without using any data structures at all but only using procedures. Here are the definitions* (SICP, 1996, 2016):
"

# ╔═╡ 90b1f8d4-266f-42ef-b6c4-46f29811e00b
md"
---
###### Constructor $cons$ as a Higher-order Function
...
**Fig. 2.1.3.1** Diagram of Higher-order Function $cons$ (= Constructor)
...
function cons(x, y)
	...
	function dispatch(message)
		==(message, :car) ? x :
		==(message, :cdr) ? y :
		"error: message not :car or :cdr but $message"
	end # function dispatch
	#-------------------------------------
	dispatch # return the function dispatch
end # function cons

# ╔═╡ 6ef6eda9-212a-4bb7-b4c6-961008c2dc2e
md"
---
###### Selector $car$
"
...
# ╔═╡ 0dc421d1-acdc-45e5-aaef-6c289c6ca050
md"
---
###### Selector $cdr$
"
...
# ╔═╡ 527cd435-417d-4bec-a1b7-3bfed9967bbc
cons(x, y)(:car)                        # ==> :a  -->  :)

# ╔═╡ b15f3e9d-6fef-488e-ad8e-26d9cf40b34c
cons(x, y)(:cdr)                        # ==> :b  -->  :)

# ╔═╡ 30c2a1f9-1599-4712-8a6d-eb7da8610218
cons(x, y)(:cadr)                       # ==> "error: ..."
...
---
##### 6. References
- **Abelson, H., Sussman, G.J. & Sussman, J.**; [*Structure and Interpretation of Computer Programs*](https://mitp-content-server.mit.edu/books/content/sectbyfn/books_pres_0/6515/sicp.zip/full-text/book/book.html), Cambridge, Mass.: MIT Press, (2/e), 1996; last visit 2025/05/02

- **Abelson, H., Sussman, G.J. & Sussman, J.**; [*Structure and Interpretation of Computer Programs*](https://web.mit.edu/6.001/6.037/sicp.pdf), Cambridge, Mass.: MIT Press, (2/e), 2016; last visit 2025/05/02
...
- **Wikipedia**; [*Algebraic Data Type*](https://en.wikipedia.org/wiki/Algebraic_data_type); last visit 2025/05/02

- **Wikipedia**; [*Object Orientated Programming (OOP)*](https://en.wikipedia.org/wiki/Object-oriented_programming); last visit 2025/05/03
