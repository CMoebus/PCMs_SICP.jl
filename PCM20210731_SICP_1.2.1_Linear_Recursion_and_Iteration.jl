...
md"
===================================================================================
 ### SICP: [1.2.1 Linear Recursion and Iteration](https://sarabander.github.io/sicp/html/1_002e2.xhtml#g_t1_002e2_002e1)
...
md"
---
#### 1.2.1.2 idiomatic *imperative* JULIA ...
###### ... with type 'Signed', *self-defined* abstract type 'FloatOrSigned', 'while', 'for', and *update* operators '+=', '+='
"
...
# ╔═╡ 8c8fe78d-dddc-4034-87ad-76b2b47cc875
md"
###### 2nd *typed* 'Signed' (specialized) method of function 'factorial'
"
...
md"
###### replacing *tail-recursion* by *iteration* with 'for'
"

# ╔═╡ 8d102915-60f0-417d-b8cf-eff22f2abd11
FloatOrSigned = Union{AbstractFloat, Signed}

# ╔═╡ 0e1023eb-b9b6-42b6-8a4e-6287a735309f
md"
###### 4th self-defined abstract *typed* 'FloatOrSigned' (specialized) method of function 'factorial'
"
