...
# ╔═╡ 82dab45d-a94b-41fb-87c1-f5fe3d8cf300
using Plots

# ╔═╡ ac1f2b50-7e0a-11ed-0185-57234c8c876d
md"
===================================================================================
...
let
	...
	#-------------------------------------------------------------------------------
	plotBinaryTree!("Triangle(s)", "Quadrilateral(s)", "Polygon(s)", xMax-11.0, yMax-0.0; widthOfTree=width10, heightOfTree=3.0, fontSize=8, arrow=arrow, rootIsTop=true)
	#------------------------------------------------------------------------------
	plotBinaryTree!("Isoscele(s)", "Right(s)", "Triangle(s)", xMax-16.0, yMax-3.0; widthOfTree=width5, heightOfTree=4.5, fontSize=8, arrow=arrow, rootIsTop=true)
	#------------------------------------------------------------------------------
	plotBinaryTree!("Trapezoid(s)", "Kite(s)", "Quadrilateral(s)", xMax-6.0, yMax-3.0; widthOfTree=width5, heightOfTree=3.0, fontSize=8, arrow=arrow, rootIsTop=true)
	#------------------------------------------------------------------------------
	plotBinaryTree!("Isoscele(s)", "Right(s)", "IsoscelesRight(s)", xMax-16.0, yMax-11.0; widthOfTree=width5, heightOfTree=3.5, fontSize=8, arrow=:tail, rootIsTop=false)
	#------------------------------------------------------------------------------
	plotUnaryTree!("Isoscele(s)", "Equilateral(s)", xMax-18.5, yMax-13.0; heightOfTree=5.5, fontSize=8, arrow=nothing, rootIsTop=false)
	#------------------------------------------------------------------------------
	plotBinaryTree!("Rectangle(s)", "Rhomb(us|i)", "Square(s)", xMax-6.0, yMax-13.0; widthOfTree=5.0, heightOfTree=3.0, fontSize=8, arrow=:tail, rootIsTop=false)
	#------------------------------------------------------------------------------
	plotUnaryTree!("Trapezoid(s)", "Parallelogram(s)", xMax-8.5, yMax-8.0; heightOfTree=2, fontSize=8, arrow=:tail, rootIsTop=false)
	#------------------------------------------------------------------------------
	plotUnaryTree!("Kite(s)", "", xMax-3.5, yMax-10.5; heightOfTree=4.5, fontSize=8, arrow=:tail, rootIsTop=false)
	#------------------------------------------------------------------------------
	plotUnaryTree!("", "", xMax-8.5, yMax-10.0; heightOfTree=2, fontSize=8, arrow=:tail, rootIsTop=false)  # Parallelogram <--> Rectangle
	#------------------------------------------------------------------------------
	plot!([(11.5, 7.7), (16.4, 6.2)], lw=1, linecolor=:black, arrow=:tail)
	#===============================================================================#
end # let

# ╔═╡ 41c792b6-4884-41b1-b3cd-573a19bf7842
md"
**Fig. 2.5.2.4.1**: *Mixed* concept hierarchy of *abstract* and *concrete* types of 2D-polygons (cf. Fig.2.26, p.199, SICP, 2/e, 1996); *plural* form of concept names (like: Polgon*s*) denotes *abstract* and *singular* form (like: Square) *concrete* types; *arrows* denote the *sub-/supertype* relation.
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "0452836833582f27a4d7528d0dc8947ecb4d04d7"
