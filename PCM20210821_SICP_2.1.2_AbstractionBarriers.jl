...
md"
#### 2.1.2.1 SICP-Scheme-like *functional*, mostly *un*typed Julia
###### ... with *imperative* construct $$while$$ and *Multiple Dispatch*
"
...
- the *first* is very *Scheme-like* by an *un*typed *named tuple* with two fields $$car$$ and $$cdr$$; the construction is deferred into the body of a constructor function $$cons1$$. 
...
md"
##### 2.1.2.1.1 Arithmetic Operations for Rational Numbers 
###### *1st* methods of functions $$add\_rat$$, $$sub\_rat$$, $$mul\_rat$$, $$div\_rat$$, $$equal\_rat$$ for type $$NamedTuple{(:car, :cdr)}$$
"
...
md"
---
##### 2.1.2.1.3 Representing Rational Numbers (... with *Named* Tuples)
