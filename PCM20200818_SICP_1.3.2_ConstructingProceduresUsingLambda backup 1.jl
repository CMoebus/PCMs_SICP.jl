...
# ╔═╡ f3d85d90-0011-11ec-02ac-a55d822f5385
md"
=====================================================================================
### SICP: [1.3.2 Constructing Procedures Using Lambda](https://sarabander.github.io/sicp/html/1_002e3.xhtml#g_t1_002e3_002e2) 

###### file: PCM20210818\_SICP\_1.3.2\_Constructing\_Procedures\_Using\_Lambda.jl 

###### Julia/Pluto.jl-code (1.8.5/19.11) by PCM *** 2023/03/08 ***
=====================================================================================
"
...
# ╔═╡ d7a1111a-76a1-4bc7-82a1-c9923efada77
(function(x) +(x, 4) end)(2)                # application to argument '2'

# ╔═╡ 0f2dc9b5-fe60-49b4-a8d0-bac1036e522f
x -> +(x, 4)                                # definition with '->'

# ╔═╡ e7f6385d-d577-41b7-804e-6b93606250f1
(x -> +(x, 4))(2)                           # application
...
# ╔═╡ c9352be7-1a37-4f96-b655-6c242580d3b1
(function(x) /(1.0, *(x, +(x, 2))) end)(2)  # application with '2'

# ╔═╡ c0888e91-7e16-436d-99c6-675077ae3caf
x -> /(1.0, *(x, +(x, 2)))                  # definition with '->'

# ╔═╡ ea44f669-b232-46f6-ba77-2ba0ee345336
(x -> /(1.0, *(x, +(x, 2))))(2)             # application with '2'

# ╔═╡ 19a7db75-2953-4dcb-9594-75a06e39a787
...
# ╔═╡ 5ce1bc1d-ca5e-4057-94f9-32e1075027da
...
integral1(x->^(x, 3), 0, 1, 0.001)

# ╔═╡ f4d0a5c5-8181-4c17-b316-5cdd092b879f
# Stark, P.A., Intro to Num. Methods, 1970, p.196f.
plot(x->-6x^5+6, 0, 1, size=(200,300), xlim=(0.0, 1.1), ylim=(0, 6.5), line=:darkblue, fill=(0, :lightblue), framestyle=:semi, title="f: x->-6x^5+6",ar=1.0, xguide="x", yguide="f: -6x^5+6")
...
integral1(x->-(6, *(6, ^(x, 5))), 0.0, 1.0, 1.0E-4) # should be 5.0

# ╔═╡ 57381fd7-5c76-4ac8-9126-660cfa6fd108
md"
###### Using Let to create local variables
"

# ╔═╡ f0e12ab0-b339-4687-83f4-6637f8dc3a9a
md"
$$f(x, y)=x(1+xy)^2+y(1-y)+(1+xy)(1-y)$$
"

# ╔═╡ 72a26f90-7b04-4afb-b695-4be97ba2eaa5
f(x, y) = 
	+(*(x,(+(1, *(x, y))^2)), 
	  *(y, -(1, y)), 
	  *(+(1, *(x, y)), -(1, y)))

# ╔═╡ e4c74e71-7286-4776-866a-eb9eeabb9e7d
f(1, 2)
...
# ╔═╡ 38f11dee-4234-41e8-8358-c9a36a3ad684
f1(1, 2)

# ╔═╡ 59aa51e0-67a2-414b-bdb7-d5e9a9a2da17
function f2(x, y)
	((a, b) -> 
		+(*(x,a^2),*(y,b),*(a,b)))(+(1,*(x,y)),-(1,y)) # λ, arg must be inline !
end # function f2

# ╔═╡ 2c5cf1dd-5195-4090-8b62-4806d4fe8b53
f2(1, 2)

# ╔═╡ 7b39c6b7-1371-460e-8ec2-99a9684530da
function f3(x, y)
	(function (a, b)
		+(*(x,a^2),*(y,b),*(a,b)) 
...
# ╔═╡ 63ad1643-0b1d-406e-b53b-6361d40e3bbd
f3(1, 2)     # f3(1, 2) ==> 4

# ╔═╡ c100451d-1d2e-4753-afe3-ed8ed8e4af91
function f4(x, y)
	let a = +(1, *(x, y)), b = -(1, y) 
...
# ╔═╡ 0a1df3a4-6ac1-4a98-820f-99655edaeef8
f4(1, 2)

# ╔═╡ 4fe7547c-e67a-4ede-b66a-6356bc07113d
let x = 5
	let x = 3
		+(x, *(x, 10))
...
# ╔═╡ c06cd287-2731-40e3-8ae6-d339541480fe
let x = 5
	let x = 3
		+(x, *(x, 10))
	end 
	+ x        # to add the value of inner let '+ x' must be inline with 'end' !
end

# ╔═╡ 749d83b3-476d-4865-a461-e41714d6805f
...
# semantics of Julia's 'let' can be made Scheme-like by idiomatic '(...)'-tuples
let x = 2   
	let (x, y) = (3, +(x, 2)) # 'let' is now semantical identic to Scheme's 'let' !
		*(x, y)
	end
end
...
# ╔═╡ 54431c34-1342-4a73-881b-5121f71a9de3
cpsIfThenElseN(n, condition, kTrue, kFalse) = condition ? kTrue(n) : kFalse(n)
...
# ╔═╡ 33a50fac-10d8-4037-9e00-47f6f61d135a
cpsIfThenElseN(0, ==(0, 0), value -> print("true case n = $value "), value -> print("false case n = $value "))

# ╔═╡ c39fc57c-3600-4df2-90a4-a645d4b53cb4
cpsIfThenElseN(5, ==(5, 0), value -> print("true case n = $value "), value -> print("false case n = $value "))
...
# ╔═╡ b3bced19-52ff-42c3-afb5-79c52372890c
function factorialCPS2(n, k)
	cpsEq(n, 0, isZero -> 
		 cpsIfThenElseN(n, isZero, 
			 		k(1),                         # true continuation
					cpsSub(n, 1, nSub1 ->         # false continuation
								factorialCPS2(nSub1, 
											facValNSub1 ->
															cpsMult(n, facValNSub1, k)))))
...
# ╔═╡ 4447ab10-16b5-4b93-b29d-7b3c6954dd02
factorialCPS2(0, result -> result)

# ╔═╡ ad2cef48-1383-4303-a770-d53f20c5edfc
factorialCPS2(1, result -> result)

# ╔═╡ 5e19dad0-5c8a-4e36-8a7b-310b8024419e
#=╠═╡
factorialCPS2(1, result -> result)factorialCPS2(5, value -> value)
  ╠═╡ =#
...
# ╔═╡ 69076135-0f38-4d19-b815-a9e4c34ec32f
8 * pi_sum2(1, 1E5)

# ╔═╡ e43b0313-2192-4460-a891-fbd116d876ff
deviation = abs(8 * pi_sum2(1, 1E5) - pi)

# ╔═╡ 2b72728e-692a-4d3a-98a1-6a9bd1a13889
...
# ╔═╡ 6b216752-9449-4135-97cd-1ef3f3c4c7a1
plot(x->x^3, 0, 1, size=(700, 300), xlim=(0.0, 1.1), ylim=(0.0, 1.2), line=:darkblue, fill=(0, :lightblue), aspect_ratio=1, framestyle=:semi, title="f: x->x^3", xguide="x", yguide="f: x^3")
