...
===============================================================================
 ...
 ### SICP: [1.1.2 Naming and the Environment](https://cloudflare-ipfs.com/ipfs/QmQ3C4ooSCmBMuK7mKq4sqVAfGq9y5EJpWNGVTQzC1FRms?filename=sicp.pdf)
...
# ╔═╡ 37fc7afe-2cb0-4ead-a994-5e31b1c1057a
md"
#### 1.1.2.1 SICP-Scheme-like *functional* Julia
"
...
md"
---
#### 1.1.2.2 idiomatic *imperative* Julia-code ...
###### ... with Julia's constant pi, types, *infix* and *postfix* operators, and *juxtaposition*
"
