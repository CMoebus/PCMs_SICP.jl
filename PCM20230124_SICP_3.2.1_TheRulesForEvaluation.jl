...
md"
*square* evaluates to $$\lambda$$-expression: $$square \Rightarrow \lambda x.*(x, x) \equiv x \rightarrow *(x, x)$$
"
...
md"
Evaluation of $$square(6)$$ in *E0* and *E1*:

$$square(6) \Longrightarrow 36$$ after parameter-argument binding and extension of E0 to E1.
"
