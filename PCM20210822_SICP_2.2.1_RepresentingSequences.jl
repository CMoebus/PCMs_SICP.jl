...
###### Julia/Pluto.jl-code by PCM *** 2022/09/04 ***
======================================================================================
"
...
Fig 2.2.1:  *Latent* box-and-pointer structure generated by $$cons(:one,\text{"two"})$$ (s.a. Fig. 2.2, SICP, 1996)
...
Fig 2.2.4:  The *latent* box-and-pointer structure of a *chain* (= *list*) of pairs generated by $$cons(:one, cons(\text{ "two" },cons(3, cons(4.0, :nil))))$$ (s.a. Fig. 2.4, SICP, 1996)
...
function pp(consList)  # pretty-prints a box-pointer structure as a nested expression
	#-----------------------------------------------------------------
...
pp(cons(:one,                       # latent box-pointer structure of Fig. 2.2.4
	cons("two",
		cons(3, 
			cons(4.0, :nil)))))
