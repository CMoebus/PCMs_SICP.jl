...
###### Julia/Pluto.jl-code (1.11.5/0.20.6) by PCM *** 2025/05/14 ***
=====================================================================================
"
...
SICP figures 2.2 and 2.3 only display *dotted pairs* or *box-pointer structures* which are *not* identical to lists. Here we modified these *box-pointer structures* by introducing a $cons$-*cell* and a $:nil$-*atom* so that these structures become *lists* as we know from Scheme.
...
md"
---
###### *3rd* Method of Scheme-like *Constructor* $cons$ using Julia's $Array$
"
...
md"
---
###### *1st* Method of $countLeavesOfNestedVector(vector::VectorOrAtom)::Int$ (*alias* $countLeaves(vector::VectorOrAtom)::Int)$
"
