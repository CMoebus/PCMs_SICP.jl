...
# ╔═╡ e07cc846-cc17-43df-8c78-f212f2a211e7
using Plots
...
###### Julia/Pluto.jl-code (1.8.2/19.14) by PCM *** 2022/11/04 ****
...
# ╔═╡ dc826433-95e3-48cf-b451-75fa78af5a8a
let
	#------------------------------------------------------------------------------
...
let
	...
	plotTernaryTree!("3", "5", "7", "+",   4.0, 6.0; widthOfTree=2.0)
